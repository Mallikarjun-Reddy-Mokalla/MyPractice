...
//         private static final String AD_UNIT_ID = "ca-app-pub-3940256099942544/3419835294";
         //LIVE AD
         private static final String AD_UNIT_ID = "ca-app-pub-5566071159707525/7788607408";
...
//        SharedPreferences preferences = base.getSharedPreferences("ratingMenWomen", Context.MODE_PRIVATE);
//        if(preferences.getBoolean("DeviceLangChecked", true)) {
//            SharedPreferences preferencesF = base.getSharedPreferences("ratingMenWomen", Context.MODE_PRIVATE);
//            SharedPreferences.Editor editor = preferencesF.edit();
//            editor.putBoolean("DeviceLangChecked", false);
//            editor.apply();
        ...
        if (currentLang.equals("en")) {
            ...
            super.attachBaseContext(LocaleHelper.onAttach(base, "th"));
